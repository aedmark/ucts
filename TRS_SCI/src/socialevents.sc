 ...
 ******************************************************************************
 ...
 socialevents1.sc..socialevents8.sc.
...
(procedure public (DoSocialEvent index)
	...
	(if((>= index 17) and (<= index 20))
		Load(rsSCRIPT SOCIALEVENTS5_SCRIPT)
		(switch(index)
		...
		DisposeScript(SOCIALEVENTS5_SCRIPT)
		return
	)
	(if((>= index 21) and (<= index 24))
		Load(rsSCRIPT SOCIALEVENTS6_SCRIPT)
		(switch(index)
		...
		DisposeScript(SOCIALEVENTS6_SCRIPT)
		return
	)
	(if((>= index 25) and (<= index 28))
		Load(rsSCRIPT SOCIALEVENTS7_SCRIPT)
		(switch(index)
		...
		DisposeScript(SOCIALEVENTS7_SCRIPT)
		return
	)
	(if((>= index 29) and (<= index 32))
		Load(rsSCRIPT SOCIALEVENTS8_SCRIPT)
		(switch(index)
		...
		DisposeScript(SOCIALEVENTS8_SCRIPT)
		return
	)
)
/******************************************************************************/
