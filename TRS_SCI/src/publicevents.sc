 ...
 ******************************************************************************
 ...
 publicevents1.sc..publicevents8.sc.
...
(procedure public (DoPublicEvent index)
	...
	(if((>= index 16) and (<= index 19))
		Load(rsSCRIPT PUBLICEVENTS5_SCRIPT)
		(switch(index)
		...
		DisposeScript(PUBLICEVENTS5_SCRIPT)
		return
	)
	(if((>= index 20) and (<= index 23))
		Load(rsSCRIPT PUBLICEVENTS6_SCRIPT)
		(switch(index)
		...
		DisposeScript(PUBLICEVENTS6_SCRIPT)
		return
	)
	(if((>= index 24) and (<= index 27))
		Load(rsSCRIPT PUBLICEVENTS7_SCRIPT)
		(switch(index)
		...
		DisposeScript(PUBLICEVENTS7_SCRIPT)
		return
	)
	(if((>= index 28) and (<= index 31))
		Load(rsSCRIPT PUBLICEVENTS8_SCRIPT)
		(switch(index)
		...
		DisposeScript(PUBLICEVENTS8_SCRIPT)
		return
	)
)
/******************************************************************************/
