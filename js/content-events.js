// ============================================================
// EVENTS — the actual scenarios players click through (100 of them), plus
// the wildcard's pack-wide fallback log lines (glitchLogs), used when an
// event doesn't define its own glitch.log.
