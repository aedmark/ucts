...
(procedure public (SelfEvent25)
	...
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Open three different budgeting apps\nin the same five minutes."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Check it six more times without\ndoing anything differently." 0
		"Tell yourself other people are worse\nwith money, so it's fine." 1
		"Actually write the number down\nsomewhere and make one small plan\naround it." 2
	)
...
(procedure public (SelfEvent26)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Google 'average age people figure\ntheir life out' at midnight."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Get irrationally angry at your\nyounger self for the timeline they\nset." 0
		"Spiral quietly for the rest of the\nevening without telling anyone." 1
		"Notice the timeline was arbitrary,\nmade up by a much younger, much less\ninformed you." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SelfEvent27)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Flip a coin and pretend the outcome\ndoesn't matter to you."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Add it to tomorrow's list again,\nsame as every day this month." 0
		"Ask five different people what\nthey'd do, hoping one of them\ndecides for you." 1
		"Give yourself an actual deadline and\none criterion to decide by." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SelfEvent28)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Look up someone from high school you\nhaven't thought about in a decade\ninstead."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Check what they're up to again, even\nthough it never actually helps." 0
		"Congratulate their latest thing\nextra warmly to prove to yourself\nyou're not bitter." 1
		"Notice you're comparing your whole\nself to their highlight reel, and\nput the scale down." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SelfEvent29)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Answer with the most impulsive thing\nthat comes to mind, unfiltered."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Give the answer you think they want\nto hear instead of sitting in the\nblank." 0
		"Laugh it off and change the subject\nbefore the silence gets\nuncomfortable." 1
...
(procedure public (SelfEvent30)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Try to recreate the exact photo,\nright now, alone in your room."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Stare at it a while, then close the\nfolder without really processing\nanything." 0
		"Post it with a caption implying\neverything's still that happy now." 1
		"Let yourself actually miss that\nfeeling instead of performing that\nyou still have it." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SelfEvent31)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Accept a plan you don't want to go\nto, purely to prove a point to\nyourself."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Cancel the fifth one too, and repeat\nthe same explanation to yourself." 0
		"Don't examine it. Just stay in and\nlet the pattern keep going." 1
		"Ask yourself honestly whether this\nis self-care or avoidance, and\nanswer honestly." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SelfEvent32)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Buy all the equipment for it and\nstart absolutely nothing else."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Keep waiting for the readiness to\narrive on its own schedule." 0
		"Tell people you're 'about to start\nsoon' again, to keep the pressure\noff." 1
