...
(procedure public (SocialEvent9)
	...
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Start your own group chat. Name it\nsomething deeply petty."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Say nothing and quietly recalibrate\nevery friendship in your life." 0
		"Act completely unbothered,\nperforming it a little too well." 1
		"Notice it stings. Don't make it a\nbigger story than it is." 2
	)
...
(procedure public (SocialEvent10)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Throw yourself a tiny, one-person\nparade around the living room."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Refresh your phone every few minutes\nwithout admitting why." 0
		"Post something upbeat so nobody\nsuspects you noticed." 1
		"Let yourself be a little sad about\nit. That's allowed." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SocialEvent11)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Walk over and loudly introduce\nyourself as if you'd never met."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Find a reason to be near the exit\nfor the rest of the night." 0
		"Go say 'hi' first, overly warm,\nbefore they can find you." 1
		"Stay where you are. Say 'hi' if it\nhappens naturally." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SocialEvent12)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Demand a formal, itemized list of\nexactly how much better."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Say 'thank you!' brightly and file\nthe sting away for later." 0
		"Say, lightly, 'I looked good before,\ntoo!'" 1
		"Replay the sentence for the rest of\nthe night." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SocialEvent13)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Commit fully: sprint over and hug a\nnear-stranger."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"You suddenly find your phone\nextremely interesting." 0
		"Overcommit to a huge wave and walk\nover, unsure why." 1
		"Give a small, real wave and let it\nbe whatever it is." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SocialEvent14)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Produce an actual calculator and do\nthe math out loud, in real time."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Agree to split evenly and say\nnothing about the math." 0
		"Suggest, casually, splitting it by\nwhat people actually got." 1
		"Pay your share silently and feel\nweird about it for days." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SocialEvent15)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Post a single cryptic status\nimplying you know things."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Spend twenty minutes trying to\nfigure out who it was." 0
		"Post something extra likable to make\nup the difference." 1
		"Close the app. It's one person. It's\nfine." 2
	)
	(if(== choice GLITCH_CHOICE)
...
(procedure public (SocialEvent16)
	...
	= glitchText NULL
	(if(< Random(0 99) GLITCH_CHANCE_PCT)
		= glitchText "Deliver an unhinged, overly dramatic\nweather forecast, mid-conversation."
	)
	= choice PrintChoices(
		...
		290
		glitchText
		"Keep it light and safe, matching\ntheir energy exactly." 0
		"Ask a real question and see what\nhappens." 1
		"Let the conversation end there, like\nit always does." 2
	)
	(if(== choice GLITCH_CHOICE)
